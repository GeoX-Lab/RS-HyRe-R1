...
HF_REPO=${1:-}
FORCE=${FORCE:-1}
EXPORT_BASE=${EXPORT_BASE:-/g0001sr/zgz/model/multi_models}

LOCAL_DIRS=(
  # "/g0001sr/zgz/EasyR1/checknovelty/global_step_230/actor"
  "/g0001sr/zgz/EasyR1/checkmulti/global_step_480/actor"
